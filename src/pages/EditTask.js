        ...
        <div className='w-full bg-gray-100 h-screen md:flex justify-center items-center
         dark:bg-slate-800'>
            <div className='md:w-2/3 md:h-80 mt-20 md:mt-0 bg-white w-full h-screen '>
                <form onSubmit={handleUpdateTask} class="h-full dark:bg-slate-900 px-8
                 pt-6 pb-8 mb-4">
                    <div className="mb-4">
                        <input
                            class=" dark:bg-slate-800 dark:text-white appearance-none
                             border-b-[1px]   w-full
                    ...
                    <div class="mb-6">
                        ...
                        <input class="appearance-none border-b-[1px] dark:bg-slate-800
                         dark:text-white  
