        ...
        <div class="bg-gray-100 h-screen dark:bg-slate-800  ">
            <div class="container  mx-auto flex justify-center items-center h-full">
                <div class="w-full max-w-xs  dark:text-white">
                    ...
                    <form class="bg-white dark:bg-slate-900 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4 ">
                            <label class="block dark:text-white text-gray-700 text-sm font-bold mb-2" for="name">
                                Name
                            </label>
                            <input class="shadow dark:bg-slate-700 dark:text-white appearance-none border rounded w-full py-2 px-3
